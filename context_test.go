...
func TestContext_IsSet_fromEnv(t *testing.T) {
	...
	a := App{
		Flags: []Flag{
			&Float64Flag{Name: "timeout", Aliases: []string{"t"}, Sources: []FlagValueSource{EnvSource("APP_TIMEOUT_SECONDS")}},
			&StringFlag{Name: "password", Aliases: []string{"p"}, Sources: []FlagValueSource{EnvSource("APP_PASSWORD")}},
			&Float64Flag{Name: "unparsable", Aliases: []string{"u"}, Sources: []FlagValueSource{EnvSource("APP_UNPARSABLE")}},
...
func TestCheckRequiredFlags(t *testing.T) {
	tdata := []struct {
		...
		},
		{
			...
			flags: []Flag{
				&StringFlag{Name: "requiredFlag", Required: true, Sources: ValueSources{EnvSource("REQUIRED_FLAG")}},
			},
		...
		},
		{
			...
			flags: []Flag{
				&StringFlag{Name: "requiredFlag", Required: true},
				&StringFlag{Name: "optionalFlag", Sources: ValueSources{EnvSource("OPTIONAL_FLAG")}},
			},
