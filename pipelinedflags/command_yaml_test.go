...
func TestCommandYamlFileTest(t *testing.T) {
	...
	command := &cli.Command{
		...
		Flags: []cli.Flag{IntFlag{Name: "test"},
			cli.StringFlag{Name: "load"}},
		FlagSetWrapperBuilder: YamlPipelineBuilder("load"),
	}
	err := command.Run(c)
...
func TestCommandYamlFileTestGlobalEnvVarWins(t *testing.T) {
	...
	command := &cli.Command{
		...
		Flags: []cli.Flag{IntFlag{Name: "test", EnvVar: "THE_TEST"},
			cli.StringFlag{Name: "load"}},
		FlagSetWrapperBuilder: YamlPipelineBuilder("load"),
	}
	err := command.Run(c)
...
func TestCommandYamlFileTestDefaultValueFileWins(t *testing.T) {
	...
	command := &cli.Command{
		...
		Flags: []cli.Flag{IntFlag{Name: "test", Value: 7},
			cli.StringFlag{Name: "load"}},
		FlagSetWrapperBuilder: YamlPipelineBuilder("load"),
	}
	err := command.Run(c)
...
func TestCommandYamlFileFlagHasDefaultGlobalEnvYamlSetGlobalEnvWins(t *testing.T) {
	...
	command := &cli.Command{
		...
		Flags: []cli.Flag{IntFlag{Name: "test", Value: 7, EnvVar: "THE_TEST"},
			cli.StringFlag{Name: "load"}},
		FlagSetWrapperBuilder: YamlPipelineBuilder("load"),
	}
	err := command.Run(c)
