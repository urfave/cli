...
func printHelpCustom(out io.Writer, templ string, data interface{}, customFuncs map[string]interface{}) {
	...
	_, _ = t.New("helpNameTemplate").Parse(helpNameTemplate)
	_, _ = t.New("usageTemplate").Parse(usageTemplate)
	_, _ = t.New("descriptionTemplate").Parse(descriptionTemplate)
	_, _ = t.New("visibleCommandTemplate").Parse(visibleCommandTemplate)
	_, _ = t.New("copyrightTemplate").Parse(copyrightTemplate)
	_, _ = t.New("versionTemplate").Parse(versionTemplate)
	_, _ = t.New("visibleFlagCategoryTemplate").Parse(visibleFlagCategoryTemplate)
	_, _ = t.New("visibleFlagTemplate").Parse(visibleFlagTemplate)
	_, _ = t.New("visibleGlobalFlagCategoryTemplate").Parse(strings.Replace(visibleFlagCategoryTemplate, "OPTIONS", "GLOBAL OPTIONS", -1))
	_, _ = t.New("authorsTemplate").Parse(authorsTemplate)
	_, _ = t.New("visibleCommandCategoryTemplate").Parse(visibleCommandCategoryTemplate)
