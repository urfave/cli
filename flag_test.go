...
func TestStringSliceFlagApply_UsesEnvValues_noDefault(t *testing.T) {
	...
	err := set.Parse(nil)
	expect(t, err, nil)
	expect(t, fl.value.(flag.Getter).Get(), []string{"vincent van goat", "scape goat"})
}
...
func TestUint64SliceFlagApply_UsesEnvValues_noDefault(t *testing.T) {
	...
	err := set.Parse(nil)
	expect(t, err, nil)
	expect(t, fl.value.(flag.Getter).Get().([]uint64), []uint64{1, 2})
}
...
func TestFloat64SliceFlagApply_UsesEnvValues_noDefault(t *testing.T) {
	...
	err := set.Parse(nil)
	expect(t, err, nil)
	expect(t, fl.value.(flag.Getter).Get().([]float64), []float64{1, 2})
}
...
func TestTimestampFlagApply(t *testing.T) {
	...
	expect(t, err, nil)
	expect(t, fl.value.(flag.Getter).Get(), expectedResult)
}
...
func TestTimestampFlagApply_Timezoned(t *testing.T) {
	...
	expect(t, err, nil)
	expect(t, fl.value.(flag.Getter).Get(), expectedResult.In(pdt))
}
...
func TestStringMapFlagApply_UsesEnvValues_noDefault(t *testing.T) {
	...
	expect(t, fl.value.(flag.Getter).Get(), map[string]string{"vincent van goat": "scape goat"})
}
