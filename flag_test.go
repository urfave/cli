...
func TestFlagsFromEnv(t *testing.T) {
	...
	var flagTests = []struct {
		...
		{"10", 0, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntLT(3)}, NewFlagValidationError("seconds", fmt.Errorf(gteFmt, 10, 3)).Error()},
		{"10", 0, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntGT(11)}, NewFlagValidationError("seconds", fmt.Errorf(lteFmt, 10, 11)).Error()},
		{"10", 10, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntGT(5)}, ""},
		{"10", 10, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntLTE(10)}, ""},
		{"10", 10, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntGTE(10)}, ""},
		{"10", 10, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntInRange(10, 12)}, ""},
		{"10", 10, &IntFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntInRange(5, 7)}, NewFlagValidationError("seconds", fmt.Errorf(notInRangeFmt, 10, 5, 7)).Error()},
		...
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntLT(3)}, ""},
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntLTE(2)}, ""},
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntSliceLenLT(3)}, ""},
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntSliceLenLTE(2)}, ""},
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntGT(3)},
			NewFlagValidationError("seconds",
				fmt.Errorf(lteFmt, 1, 3),
				fmt.Errorf(lteFmt, 2, 3),
			).Error()},
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"}, Validator: IntSliceLenGT(3)},
			NewFlagValidationError("seconds",
				fmt.Errorf(sliceLenFmt+lteFmt, 2, 3)).Error()},
		{"1,2", newSetIntSlice(1, 2), &IntSliceFlag{Name: "seconds", EnvVars: []string{"SECONDS"},
			Validator: CombinedIntSliceValidators{IntSliceLenGT(3), IntGT(3)}},
			NewFlagValidationError("seconds",
				fmt.Errorf(sliceLenFmt+lteFmt, 2, 3),
				fmt.Errorf(lteFmt, 1, 3),
				fmt.Errorf(lteFmt, 2, 3),
			).Error()},
